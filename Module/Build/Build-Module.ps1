Build-Module -ModuleName 'WizCloud' {
    ...
    New-ConfigurationPublish -Type GitHub -FilePath 'C:\Support\Important\GitHubAPI.txt' -UserName 'EvotecIT' -Enabled:$true -ID 'ToGitHub' -OverwriteTagName 'WizCloud-PowerShellModule.<TagModuleVersionWithPreRelease>'
}
